            ...
            <form id="contactusform">
              <div class="contactusform">
                <div class="smallerdiv">
                  <input type="text" name="firstname" tabindex="1" placeholder="First Name" class="login_email" required>
                  <input type="text" name="lastname" tabindex="2" placeholder="Last Name" class="login_email" required>
                  <input type="email" name="email" tabindex="3" placeholder="Email" class="login_email" required>
                  <input type="text" name="company" tabindex="4" placeholder="Company" class="login_email">
                  <!-- <input type="text" name="country" tabindex="5" placeholder="Country" class="login_email"> -->
                  <select class="signup_country form-control bfh-countries" name="country" tabindex="5" required="" id="country_contactus" placeholder="Country" style="display: inline-block; text-transform: uppercase;">
                  ...
                  <input type="text" name="phone" tabindex="6" placeholder="Phone" class="login_email" id="contactus_phone">
                  <input type="text" name="interestedin" tabindex="7" placeholder="Interested in ..." class="login_email">
                  <input type="text" name="message" tabindex="8" placeholder="Message" class="login_email" required>
                </div>
                <div class="submitdiv">
